...
- (void)viewDidLoad {
    ...
    if (_isSelectOriginalPhoto){
        ...
        NSUserDefaults *defaultsO = [[NSUserDefaults alloc]init];
        [defaultsO setFloat:3024 forKey:@"WEIBLOG_IMG_WIDTH"];
        [defaultsO synchronize];
    }else{
        
        NSUserDefaults *defaultsO = [[NSUserDefaults alloc]init];
        [defaultsO setFloat:826 forKey:@"WEIBLOG_IMG_WIDTH"];
        [defaultsO synchronize];
    }
}
